...
### <img src="/public/brands/journey-of-reincarnation2.png" width="50px" alt="Journey of Reincarnation Logo" /> Journey of Reincarnation
[Journey of Reincarnation](https://journey-of-reincarnation2.vercel.app) is an innovative web application that I independently created from ground up - including brand identity, logo design, UI/UX design, and full-stack development. Built with Next.js 14 and TypeScript, this unique platform simulates reincarnation experiences, allowing users to explore different life circumstances across various countries and social backgrounds. The application features an interactive world map visualization using react-simple-maps, dynamic statistics dashboards powered by Chart.js, bilingual support (English/Chinese) with i18next, and immersive animations created with Framer Motion. I designed a modern, responsive interface using Tailwind CSS and shadcn/ui components, implemented dark/light theme switching, created an engaging audio system with background music and sound effects, and developed a special events system to enhance user experience. From the mystical crystal ball logo to every implementation detail, the project reflects my commitment to combining innovative technology with meaningful user interaction while raising awareness about global demographic diversity.
