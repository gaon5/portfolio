...
[Library Management System](https://github.com/ChanMeng666/library-management-system) is a modern full-stack application built with Next.js 15 and Supabase that streamlines library operations. Features real-time book tracking, user authentication, and an intuitive UI built with shadcn/ui and Tailwind CSS. The system enables users to browse, borrow, and reserve books while providing librarians with powerful management tools. Implemented with React Context for state management and React Hook Form for data handling, delivering a responsive and seamless experience across all devices.
