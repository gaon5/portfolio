...
[Library Management System](https://github.com/ChanMeng666/library-management-system) is a modern full-stack application built with Next.js 15 and Supabase. Features real-time book tracking, user authentication, and responsive UI using shadcn/ui components. Users can easily browse, borrow, and reserve books through an intuitive interface that works seamlessly across all devices.
